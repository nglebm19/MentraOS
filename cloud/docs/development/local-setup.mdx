...
<Note>
**New to MentraOS?** If you're setting up your entire development environment from scratch (including Node.js, Git, Android Studio, etc.), start with the [Complete Beginner's Setup Guide](https://docs.mentra.glass/beginner-setup-guide) first. This guide focuses specifically on cloud backend development.
</Note>
